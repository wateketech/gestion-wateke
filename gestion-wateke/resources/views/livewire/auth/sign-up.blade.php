<section class="h-100-vh mb-8">
      <div class="page-header align-items-start section-height-50 pt-5 pb-11 m-3 border-radius-lg"
          style="background-image: url('../assets/img/wallpapers/wallpaper-2.jpg');">
              ...
              <div class="row justify-content-center">
                  <div class="col-lg-5 text-center mx-auto">
                      ...
                      <p class="text-lead text-white">
                          {{ __('Use this amazing forms to log in or request an account and manage reservations with') }} Wateke Travel.
                      </p>
                  </div>
              </div>
          </div>
              ...
              <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
                  <div class="card z-index-0">
                    ...
                    <div class="card-header text-center pt-4">
                        <h5>{{ __('Register with') }} Wateke Travel</h5>
                    </div>
{{--
